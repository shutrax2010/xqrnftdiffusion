          ...
          try {
            ...
            if (response.data) {
              ...
              if (url.startsWith('ipfs://')) {
                let cleanedUrl = url.replace(/^(ipfs:\/\/)+/, '')
                imageUrl = "https://amethyst-raw-termite-956.mypinata.cloud/ipfs/" + cleanedUrl + "?pinataGatewayToken=" + process.env.PINATA_GATEWAY_KEY;
